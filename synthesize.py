...
class TextToSpeech(object):
	...
	#You need to create a config.py file and add your Azure keys in that file
        subscription_key = config.synthesize_key
    ...
    def get_token(self):
        fetch_token_url = 'https://' + config.region + '.api.cognitive.microsoft.com/sts/v1.0/issueToken'
        headers = {
    ...
    def save_audio(self):
        base_url = 'https://' + config.region + '.tts.speech.microsoft.com/'
